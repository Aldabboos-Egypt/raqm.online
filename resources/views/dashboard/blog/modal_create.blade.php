    ...
    <div class="modal-content">
        ...
        <div class="modal-body row">
            ...
            <div class="col-md-12 col-sm-12 mb-2 pt-2">
                ...
                <span class='txt-danger'></span>
                {!! Form::text('meta_description', old('meta_description'), [
                    'class' => 'form-control',
            ...
            <div class="col-md-12 col-sm-12 mb-2 pt-2">
                ...
                <span class='txt-danger'></span>
                {!! Form::text('meta_keywords', old('meta_keywords'), [
                    'class' => 'form-control',
            ...
            <div class="col-md-12 col-sm-12 mb-2 pt-2">
                ...
                {!! Form::text('meta_description_ar', old('meta_description_ar'), [
                    'class' => 'form-control',
            ...
            <div class="col-md-12 col-sm-12 mb-2 pt-2">
                ...
                {!! Form::text('meta_keywords_ar', old('meta_keywords_ar'), [
                    'class' => 'form-control',
