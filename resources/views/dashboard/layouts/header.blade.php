                 ...
                 <li class="language-nav">
                     <div class="translate_wrapper">
                         <div class="current_lang">
                             <div class="lang"><i
                                     class="flag-icon flag-icon-{{ App::getLocale() == 'en' ? 'us' : 'sa' }}"></i>
                                 <span class="lang-txt">{{ App::getLocale() }} </span>
                             </div>
                         </div>
                         <div class="more_lang">
                             <a href="{{ route('dashboard.lang', '') }}?lang=en"
                                 class="{{ App::getLocale() == 'en' ? 'active' : '' }}">
                                 <div class="lang {{ App::getLocale() == 'en' ? 'selected' : '' }}" data-value="en">
                                     <i class="flag-icon flag-icon-us"></i> <span class="lang-txt">English</span><span>
                                         (US)</span>
                                 </div>
                             </a>
                             <a href="{{ route('dashboard.lang', '') }}?lang=ar"
                                 class="{{ App::getLocale() == 'ar' ? 'active' : '' }}">
                                 <div class="lang {{ App::getLocale() == 'ar' ? 'selected' : '' }}" data-value="ar">
                                     <i class="flag-icon flag-icon-sa"></i> <span class="lang-txt">العربية</span> <span>
                                         (AR)</span>
                                 </div>
                             </a>
                         </div>
                 ...
                 <li class="profile-nav onhover-dropdown pe-0 py-0">
                     ...
                     <ul class="profile-dropdown onhover-show-div">
                         <li><a href="{{ route('dashboard.index') }}"><i
                                     data-feather="home"></i><span>{{ __('lang.dashboard') }} </span></a>
                         </li>
                         {{-- <li><a href="#"><i data-feather="user"></i><span>{{ __('lang.account') }} </span></a> --}}
                 </li>
                 <li>
                     <a href="{{ route('dashboard.logout') }}"
                         onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
                             data-feather="log-in"> </i><span>{{ __('lang.logout') }}</span></a>
