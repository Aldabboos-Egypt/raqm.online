{!! Form::open(['route' => 'dashboard.subcategories.store', 'method' => 'post', 'files' => true, 'class' => 'needs-validation was-validated']) !!}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-12 col-sm-12 mb-2 pt-2">
                    ...
                    {!! Form::text("name", old("name"), ['class' => 'form-control', 'required', 'placeholder' => __('lang.description')]) !!}
                </div>
