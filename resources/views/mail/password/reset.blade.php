                        ...
                        <tr style="display: block">
                            <td style="display: block">
                                <table style="margin-top: 80px;display: block;">
                                    ...
                                    <tr style="display: block;">
                                        <td style="background-color: #f7f7ff;padding: 15px;margin-top: 15px;display: block;">
                                            <p style='margin: 10px 0; padding: 0;color: #2a2a2a; font-size: 14px; '>
                                                If you’re having trouble clicking the "Reset Password" button, copy and paste the URL below into your web browser:
                                            </p>
                                            <div style="padding-bottom: 18px;">
                                                <a href="{{ $url }}" style="color: #8ab630; font-weight: normal; text-decoration: none;font-size: 14px;word-break: break-all;" target="_blank">{{ $url }}</a>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
