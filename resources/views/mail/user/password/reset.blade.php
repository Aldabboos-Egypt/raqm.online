            ...
            <tr>
                <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td style="background-color: #ffffff;padding: 20px 30px 20px 30px; color: #666666; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <h1 style='color: #2a2a2a; font-size: 32px; font-style: normal;font-weight: bold;line-height:125%;display: block;margin: 0;padding: 0'>
                                    <span style="text-transform:uppercase">{{ __('lang.forgot_your_password_title') }}</span>
                                </h1>
                                <h2 style='color: #2a2a2a;font-size: 24px; font-style: normal;font-weight: bold;line-height:125%;display: block;margin: 0;padding: 0'>
                                    <span style="text-transform:uppercase">{{ __('lang.forgot_your_password_content') }}</span>
                                </h2>
                                <p>{{ __('lang.received_request_reset_password') }}</p>
                                <p>{{ __('lang.please_use_below_information') }}</p>
                                <p style="margin: 0;"><strong>{{ __('lang.code') }}: <span  style="color: #8ab630">{{ $token }}</span></strong></p>
                                <p style="margin: 0;font-size: 14px;">({{ __('lang.code_is_valid_min') }})</p>
                                <p style="font-size: 14px;">{{ __('lang.please_ignore_email_request') }}</p>
                        ...
                        <tr>
                            <td bgcolor="#ffffff" style="padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-size: 18px; font-weight: 400; line-height: 25px;">
