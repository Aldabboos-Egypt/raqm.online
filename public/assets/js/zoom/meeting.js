...
function websdkready() {
  ...
  tmpArgs.name = document.name;
  tmpArgs.mn = document.meetingNumber;
  tmpArgs.sdkKey = document.sdkKey;
  tmpArgs.pwd = document.pwd;
  tmpArgs.email = document.email;
  tmpArgs.role = document.role;
  tmpArgs.signature = document.signature;
